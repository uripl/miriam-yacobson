    ...
    <div className="about-project-page">
      <header className="page-header">
        <div className="container">
          <h1>אודות הפרויקט</h1>
          <p className="subtitle">הנצחת סיפורה של סבתא מרים אופנהיימר (יעקובסון)</p>
        </div>
      </header>
      ...
      <div className="container">
        <div className="about-project-content">
          <section className="about-project-intro">
            <h2>מטרת הפרויקט</h2>
            <p>
              הפרויקט "מאפילה לאורה" נוצר במטרה לשמר ולהנציח את סיפור חייה המיוחד של סבתא מרים אופנהיימר (יעקובסון),
