...
export const chaptersContent = {
  ...
  // פרקים מינימליים
  belgium: {
    title: "החיים בבלגיה (1938-1940)",
    subtitle: "תקופת ההסתגלות באנטוורפן",
    paragraphs: ["המשפחה הגיעה לבלגיה ב-1938 והתאחדה באנטוורפן."],
    images: [],
    quotes: []
  },
  
  france: {
    title: "צרפת תחת הכיבוש (1940-1944)",
    subtitle: "שנים של מסתור ובריחה",
    paragraphs: ["בעקבות פלישת הנאצים לבלגיה, המשפחה נמלטה לצרפת."],
    images: [],
    quotes: []
  },
  
  holocaust: {
    title: "בעמק הבכא (1944-1945)",
    subtitle: "התקופה במחנות",
    paragraphs: ["מרים ואביה נשלחו למחנה אושוויץ."],
    images: [],
    quotes: []
  },
  
  liberation: {
    title: "השחרור והחזרה לליון (1945-1948)",
    subtitle: "תקופת השיקום",
    paragraphs: ["מרים שוחררה בידי הצבא הסובייטי וחזרה לליון."],
    images: [],
    quotes: []
  },
  
  immigration: {
    title: "העלייה לישראל (1948)",
    subtitle: "המסע לארץ ישראל",
    paragraphs: ["באפריל 1948 הפליגה מרים מנמל מרסיי לארץ ישראל."],
    images: [],
    quotes: []
  },
  
  israel: {
    title: "חיים בארץ ישראל (1948-2023)",
    subtitle: "בניית הבית והמשפחה",
    paragraphs: ["מרים הגיעה לחיפה והתיישבה בקיבוץ חפץ חיים."],
    images: [],
    quotes: []
  }
};
